...
LOOP_TIMEOUT = 20 * 60  # fact loop timeout maybe from LOOP_TIMEOUT to LOOP_TIMEOUT*2 (random use)
...
HERO_TERROR_MIN_ENEMIES_STRENGTH = 5000
...
ENABLE_SEND_CANNON_RUBBER_FARMS = True
